...
class _AppApi implements AppApi {
  ...
  @override
  Future<FavoritesResponse> addOrDeleteFavoritesProduct(dynamic id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'product_id': id};
    final _result = await _dio
  ...
  Future<AllProductsFavoritesResponse> getAllProductsFavorites() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AllProductsFavoritesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AllProductsFavoritesResponse.fromJson(_result.data!);
    return value;
  }
